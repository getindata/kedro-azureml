...
class AzureMLPandasDataSet(AbstractDataSet):
    ...
    Args:
        ...
        azureml_dataset_save_args: Additional arguments to pass to `TabularDatasetFactory.register_pandas_dataframe` method.
            please read more here: https://learn.microsoft.com/en-us/python/api/azureml-core/azureml.data.dataset_factory.tabulardatasetfactory?view=azure-ml-py#azureml-data-dataset-factory-tabulardatasetfactory-register-pandas-dataframe
