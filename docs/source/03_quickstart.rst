...
.. code:: console
   ...
   #Usage: kedro azureml init [OPTIONS] RESOURCE_GROUP WORKSPACE_NAME SUBSCRIPTION_ID
   #                          EXPERIMENT_NAME CLUSTER_NAME STORAGE_ACCOUNT_NAME
   #                          STORAGE_CONTAINER ENVIRONMENT_NAME
   kedro azureml init <resource-group-name> <workspace-name> <subscription-id> <experiment-name> <compute-cluster-name> <storage-account-name> <storage-container-name> <environment-name>
